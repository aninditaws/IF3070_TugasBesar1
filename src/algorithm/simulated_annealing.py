...
class SimulatedAnnealing:
    ...
    def find_random_neighbor(self):
        ...
        while pos1 == pos2:
            pos2 = (random.randint(0, self.cube.size - 1), random.randint(0, self.cube.size - 1), random.randint(0, self.cube.size - 1)) # Memastikan dua posisi yang dipilih berbeda
        ...
        while temperature > self.final_temperature:
            ...
            if delta < 0:
                ...
                # Solusi yang buruk tidak diambil jika probabilitasnya tidak lebih besar dari threshold    
                    ...
                    self.swap_elements(pos1, pos2) # Menukar kembali kedua elemen di posisi tersebut: posisi elemen tidak jadi berubah

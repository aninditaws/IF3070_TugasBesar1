...
print("\n=== Algorithm with the Worst Improvement ===")
print(f"Algorithm: {worst_algorithm_delta['algorithm']}")
print(f"Delta: {worst_algorithm_delta['delta']}")
print(f"Final Score: {worst_algorithm_delta['final_score']}")
